<template>
  <div>
     ...
     <div class="container-fluid">
             <div class="row">
                  <FormBuilder
                    api-model="discountaccess"
                    card-title="Create New Discount Access"
                    :card-button="cardButton"
                    success-message="Discount Access Succesfully Added!"
                ...
                <FormBuilder
                    api-model="discountaccess"
                    card-title="Update Discount Access"
                    :card-button="cardButtonUpdate"
                    success-message="Discount Access Succesfully Updated!"
                    card-size="modal-dialog modal-dialog-centered modal-lg"
                    :card-input="form"
                   ...
                   <div class="col-md-12">
                    <!-- START OF TABLE LIST  -->
                        ...
                        <template v-else>
                              ...
                              :check-box="checkBox"
                              api-model="discountaccess"
                              table-name="Discount Access"
                              :show-fields="showFields"
                              delete-message="Discount Access Succesfully Deleted!"
                              :indexed-filter="indexedFilter"
